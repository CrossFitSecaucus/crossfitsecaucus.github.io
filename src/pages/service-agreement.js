...
const ServiceAgreementPage = () => (
  <main className="container">
    <div className="row">
      ...
      <div className="col-xs-10 offset-xs-1 col-xl-8 offset-xl-2">
        <h2 style={{paddingTop: 100, marginBottom: -100}}>CrossFit Secaucus</h2>
        <h3 style={{paddingTop: 100, marginBottom: -100}}>Service Agreement</h3>

        <p style={{paddingTop: 150, marginBottom: -150}}>
        ...
        <p style={{paddingTop: 175, marginBottom: -175}}>
        ...
        <p style={{paddingTop: 200, marginBottom: -200}} id="automatic-renewals">
        ...
        <p style={{paddingTop: 200, marginBottom: -200}} id="cancellation">
        ...
        <p style={{paddingTop: 200, marginBottom: -200}} id="hold">
          <strong>Hold: </strong>
        ...
        <p style={{paddingTop: 200, marginBottom: 0}}>&nbsp;</p>
