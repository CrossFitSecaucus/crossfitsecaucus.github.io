  ...
  <main className="row">
    ...
    <div className="col-sm-10 offset-sm-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
      ...
      <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
        accessible at CrossFit Secaucus unless otherwise defined in this Privacy Policy.
      </p>

      <h3>Information Collection and Use</h3>
      <p>For a better experience, while using our Service, I may require you to provide us with certain
        personally identifiable information, including but not limited to name, email, phone number, and fitness performance data. The information that I request will be retained on your device as well as on remote servers.
      </p>
